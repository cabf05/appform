...
def create_meeting_table(supabase, table_name, meeting_name, max_number=999):
    ...
    try:
        ...
        st.write(f"Registrando metadados para {table_name}...")
        ...
        st.write(f"Metadados registrados: {response_metadata.data}")

        # Passo 2: Criar a tabela dinamicamente via RPC
        st.write(f"Criando tabela {table_name}...")
        ...
        # Rollback: remover metadados e tabela em caso de falha
        try:
            st.write(f"Executando rollback para {table_name}...")
