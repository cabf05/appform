...
if mode == "participant" and table_name_from_url:
    ...
    if page == "Configuração":
        ...
        with st.form("config_form"):
            ...
            supabase_key = st.text_input("Chave API do Supabase (use service_role)", type="password", value=saved_key)
...
4. Copie a URL e a chave 'service_role'
...
ALTER TABLE meetings_metadata DISABLE ROW LEVEL SECURITY;
    ...
    # --- Página 3: Atribuir Número (Master) ---
